...
var itemList = [
    { id: '0001', name: 'ソファベッド', tags: ['ベッド', 'ソファ', '寝具'], price: '100円'},
    { id: '0002', name: 'シングルベッド', tags: ['ベッド', 'ソファ', '寝具'], price: '110円'},
    { id: '0003', name: '子ども用ベッド', tags: ['ベッド', 'ソファ', '寝具', '子ども部屋家具'], price: '120円'},
    { id: '0004', name: 'ソファ', tags: ['ソファ'], price: '140円'},
    { id: '0005', name: 'キューブボックス', tags: ['家具・ラック', '収納システム'], price: '150円'},
    { id: '0006', name: 'オープンラック', tags: ['家具・ラック', '収納システム'], price: '130円'},
    { id: '0007', name: 'コンピュータデスク', tags: ['テーブル・椅子'], price: '120円'},
    { id: '0008', name: 'サイドテーブル', tags: ['テーブル・椅子'], price: '110円'},
    { id: '0009', name: 'ダイニングテーブル', tags: ['テーブル・椅子'], price: '144'},
    { id: '0010', name: '子ども部屋用収納', tags: ['収納システム', '子ども部屋家具'], price: '222円'},
    { id: '0011', name: 'miniパン', tags: ['調理器具', 'フライパン'], price: '213円'},
    { id: '0012', name: 'bigパン', tags: ['調理器具', 'フライパン'], price: '231円'},
    { id: '0013', name: 'mini鍋', tags: ['調理器具', '鍋'], price: '421円'},
    { id: '0014', name: 'big鍋', tags: ['調理器具', '鍋'], price: '132円'},
];
...
function viewItemList(tag) {
    ...
    for (let i = 0; i < itemList.length; i++) {
        if (itemList[i].tags.some(t => t === tag)) {
            ...
            // テキスト情報を作成
            let text = document.createTextNode(itemList[i].id + ':' + itemList[i].name + '  （価格）:' + itemList[i].price);
            // ul要素に追加
            li.appendChild(text);
